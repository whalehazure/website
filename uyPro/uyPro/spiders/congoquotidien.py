...
class CongoquotidienSpider(scrapy.Spider):
    name = "congoquotidien"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.congoquotidien.com/category/appels-offres-rdc/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.congoquotidien.com/category/dernieres-nouvelles-rdc/',
            'https://www.congoquotidien.com/category/appels-offres-rdc/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[contains(@class, 'tdb_module_loop')]//h3/a/@href|//div[@id='tdi_67' and "
                               "@class='td_block_inner']//div[@class='td-module-thumb']/a/@href").getall()
        for link in links:
            if not link:
                continue

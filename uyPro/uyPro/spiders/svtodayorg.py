...
class SvtodayorgSpider(scrapy.Spider):
    name = "svtodayorg"
    ...
    custom_settings = {
        ...
        'USER_AGENT': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/'
                      '537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36',
        # 'LOG_ENABLED': True
    }
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://svtoday.org/world-news/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://svtoday.org/united-states/',
            'https://svtoday.org/world-news/',
            'https://svtoday.org/technology-news/',
            'https://svtoday.org/business-news/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//ul/li//h3/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//nav/a[@data-wp-key='query-pagination-next']/@href").get()

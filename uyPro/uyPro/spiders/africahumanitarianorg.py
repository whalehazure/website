...
class AfricahumanitarianorgSpider(scrapy.Spider):
    name = "africahumanitarianorg"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://africahumanitarian.org/get-involved/stories/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://africahumanitarian.org/get-involved/stories/'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//article[@id]/div/h3[@class='entry-title']/a/@href").getall()
        for link in links:
            if not link:
                continue

...
class TrustafricaorgSpider(scrapy.Spider):
    name = "trustafricaorg"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://trustafrica.org/publication/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://trustafrica.org/news/',
            'https://trustafrica.org/publication/'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div/article[@id]/h2[@class='entry-title']/a/@href|//div["
                               "@class='et_pb_module_inner']/a[@class='et_pb_button']/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@class]/div[@class='alignleft']/a/@href|//ul[@class='page-numbers']/li/a["
                                  "@class='next page-numbers']/@href").get()
    ...
    def article(self, response):
        ...
        if tweet_func:
            ...
            if item:
                tweet_pdf_urls = response.xpath("//div[@id='main-content']//div[@class]//div/embed/@src").getall()

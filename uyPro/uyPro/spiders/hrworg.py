...
class HrworgSpider(scrapy.Spider):
    name = "hrworg"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.hrw.org/zh-hans/news?keyword=&created='
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.hrw.org/news?keyword=&created=',
            'https://www.hrw.org/zh-hans/news?keyword=&created='
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        next_url = response.xpath("//nav[@class='pager']/ul/li[@class='pager__item pager__item--next']/a/@href").get()
    ...
    def article(self, response):
        ...
        item['tweet_id'] = link
        lang = 'zh' if 'zh-hans' in response.url else 'en'

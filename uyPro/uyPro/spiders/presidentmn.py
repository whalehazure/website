...
class PresidentmnSpider(scrapy.Spider):
    name = "presidentmn"
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div/article[@id]/div//h5[@class='entry-title']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div/a[@class='next page-numbers']/@href").get()

...
class MoigovSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.moi.gov.mm/moi%3Aeng/index.php/news'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.moi.gov.mm/moi%3Aeng/index.php/news',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='item']/span//div[@class='card-title news-title']/h2/a/@href").getall()
        for link in links:
            if not link:
                continue

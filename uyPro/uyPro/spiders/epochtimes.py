...
class EpochtimesSpider(scrapy.Spider):
    name = "epochtimes"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.epochtimes.com/gb/nsc413.htm'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.epochtimes.com/gb/tag/%E6%B3%95%E8%BD%AE%E5%8A%9F.html',
            'https://www.epochtimes.com/gb/nsc413.htm',
            'https://www.epochtimes.com/gb/ncid1456792.htm',
            'https://www.epochtimes.com/gb/news392.htm'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='posts_list']/ul/li/span[@class='info']/div["
                               "@class='title']/a/@href|//div[@class='post_list left_col']/div[contains(@class,"
                               "'one_post')]/div[@class='text']/div[@class='title']/a/@href|//div[@id='artlist']/div["
                               "@class='posts column']/div[@class='arttitle column']/a/@href|//div[@class='topbox "
                               "column']/div/div[@class='arttitle']/a/@href|//div["
                               "@class='inspired-category-posts-list']/ul/li/div[@class='text']/h2/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@class='pagination']/a[@class='next page-numbers']/@href|//ul["
                                  "@class='pagination']/li/a[text()='下一页']/@href").get()

...
class TibetanyouthcongressSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.tibetanyouthcongress.org/tibet-news-2/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.tibetanyouthcongress.org/tibet-news-2/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath(
            "//main[@id='main']/article/div[@class='entry-content']//a[@title='Read more']/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        # next_url = response.xpath("//nav[@class='elementor-pagination']/a[@class='page-numbers next']/@href").get()

...
class ChildrenofafricangoSpider(scrapy.Spider):
    name = "childrenofafricango"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.childrenofafrica.ngo/news/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.childrenofafrica.ngo/news/?lang=en',
            'https://www.childrenofafrica.ngo/news/'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='articles-list__inner-content']/div/article["
                               "@class='articles-list__element']/a/@href").getall()
        for link in links:
            if not link:
                continue

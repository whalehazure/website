...
class CnacomtwSpider(scrapy.Spider):
    name = "cnacomtw"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.cna.com.tw/tag/35418/'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.cna.com.tw/tag/35418/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='statement']/ul[@class='mainList tagListStyle'][1]/li/a/@href").getall()
        for link in links:

...
class MshulbacbeSpider(scrapy.Spider):
    name = "mshulbacbe"
    ...
    def __init__(self, name=None):
        ...
        self.bid = ''
        self.inc = ''
        self.proname = "mshulbacbe"

    def start_requests(self):
        homepage = ''
        # homepage = 'https://msh.ulb.ac.be/'
        # link = 'https://msh.ulb.ac.be/en/news/appel-a-communications-tourisme-et-francophonie-les-circulations-' \
        #        'touristiques-entre-l-amerique-du-nord-et-l-europe-aux-xixe-et-xxe-siecles-1'
        # churl = 'https://msh.ulb.ac.be/en/news'
        try:
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            # 'https://msh.ulb.ac.be/en/news',
            'https://msh.ulb.ac.be/en/agenda',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='index__content']/article/div[@class='block__inner']/div[@class='block_"
                               "_section'][1]/a[@class='block__link']/@href|//div[@class='index__content']/article/"
                               "div[@class='block__inner']/a[@class='block__link']/@href").getall()
        for link in links:
            # link = response.urljoin(link)
            link_hash = hashlib.sha1(link.encode()).hexdigest()
            # if self.redis_conn.sismember('mshulbacbe_done_urls', link_hash) and self.inc:
        ...
        next_url = response.xpath("//ul[@class='pagination__list']/li/a[@aria-label='Next']/@href|//section[@class="
                                  "'index index--events']/a[@class='button button--text']/@href").get()
        ...
        if tweet_func:
            ...
            if item:
                ...
                if not item.get('tweet_content') or item.get('tweet_content_tslt'):
                    ...
                    # self.redis_conn.sadd('mshulbacbe_done_urls', link_hash)
                yield item

...
class RadiookapinetSpider(scrapy.Spider):
    name = "radiookapinet"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.radiookapi.net/revue-de-presse'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            ...
            'https://www.radiookapi.net/economie',
            'https://www.radiookapi.net/societe',
            'https://www.radiookapi.net/environnement',
            'https://www.radiookapi.net/revue-de-presse'
        ]
        for link in chlinks:

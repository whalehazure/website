...
class PhayulSpider(scrapy.Spider):
    name = "phayul"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.phayul.com/opinion/'
            # inputdata = {}
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='elementor-widget-container']//article/div["
                               "@class='elementor-post__text']/h3/a/@href").getall()
        for link in links:
            if not link:
                continue

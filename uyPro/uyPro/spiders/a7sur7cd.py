...
class A7sur7cdSpider(scrapy.Spider):
    name = "7sur7cd"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://7sur7.cd/category/appels-doffre'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://7sur7.cd/index.php/category/politique',
            'https://7sur7.cd/index.php/category/economie',
            'https://7sur7.cd/index.php/category/sante',
            'https://7sur7.cd/index.php/category/societe',
            'https://7sur7.cd/category/appels-doffre'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//h2[@class='field-content']/a/@href").getall()
        for link in links:
            if not link:
                continue

...
class AsudagovtmSpider(scrapy.Spider):
    name = "asudagovtm"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://asuda.gov.tm/habar'
            # inputdata = {}
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@id='posts']/div//div[@class='entry-title']/h2/a/@href").getall()
        for link in links:
            if not link:
                continue

...
class SavetibetorgSpider(scrapy.Spider):
    name = "savetibetorg"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://savetibet.org/latest-news/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://savetibet.org/latest-news/',
            'https://savetibet.org/latest-news/newsletters/'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//main[@id='main']//section[@id='content']//article//a["
                               "@class='fusion-read-more']/@href|//main[@id='main']//section["
                               "@id='content']//article//a[contains(@class,'fusion-button')]/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[contains(@class,'pagination')]/a[@class='pagination-next']/@href").get()
    ...
    def article(self, response):
        ...
        if tweet_func:
            ...
            if item:
                tweet_pdf_urls = response.xpath("string(//div[@class='fusion-alignleft']/a[span[text()='DOWNLOAD THE "
                                                "ISSUE (PDF) »']]/@href)").getall()

...
class XizangzhiyeSpider(scrapy.Spider):
    name = "xizangzhiye"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://xizang-zhiye.org/newscategory/'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://xizang-zhiye.org/newscategory/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='w-grid-list']/article/div[@class='w-grid-item-h']/h4/a/@href").getall()
        for link in links:
        ...
        next_url = response.xpath("//nav[@class='pagination navigation']/div/a[@class='next page-numbers']/@href").get()

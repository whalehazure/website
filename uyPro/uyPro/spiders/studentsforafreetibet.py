...
class StudentsforafreetibetSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://studentsforafreetibet.org/latest/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://studentsforafreetibet.org/latest/'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//main[@class='main']/div/div[@class='news-card']//a[@class='btn']/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//main[@class='main']/div[@class='row row--pagination'][2]/a[@class='next "

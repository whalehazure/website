...
class MyformosaSpider(scrapy.Spider):
    name = "myformosa"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'http://my-formosa.com/KM/M_10.htm'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'http://my-formosa.com/KM/M_5.htm',
            'http://my-formosa.com/KM/M_6.htm',
            'http://my-formosa.com/KM/M_10.htm',
        ]
        for link in chlinks:

...
class PoliticoSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.politico.com/search?q=china&s=newest'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.politico.com/defense-national-security-foreign-policy-news-updates-analysis',
            'https://www.politico.com/congress-news-updates-analysis',
            'https://www.politico.com/white-house-news-updates-analysis',
            'https://www.politico.com/search?q=china&s=newest',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//p[@class='media-item__title']/a/@href|//div[@class='summary']/header/h3/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@class='contextual']/a[text()='Next page »']/@href").get('').replace('amp%3B', '')

...
class UsatodaySpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.usatoday.com/opinion/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            ...
            'https://www.usatoday.com/search/?q=china',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//main/div[@class='gnt_pr']/div[not(@class='gnt_m_bdl_t' or @class='gnt_m gnt_m_sc' "
                               "or @class='gnt_se_pgn_count' or @class='gnt_se_pgn')]/a/@href|//main/div["
                               "@class='gnt_pr']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//main/div[@class='gnt_pr']/div[@class='gnt_se_pgn']/a[contains(@class,"
                                  "'gnt_se_pgn_pn__nt')]/@href").get()

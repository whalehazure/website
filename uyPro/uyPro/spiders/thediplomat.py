...
class ThediplomatSpider(scrapy.Spider):
    name = "thediplomat"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://thediplomat.com/regions/central-asia/'
            # inputdata = {}
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='td-posts td-posts--col']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@class='td-list-pager td-list-pager--bottom']/div["
                                  "@class='td-list-pager__nav']/a[text()='Older']/@href").get('')

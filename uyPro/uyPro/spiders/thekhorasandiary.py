...
class ThekhorasandiarySpider(scrapy.Spider):
    name = "thekhorasandiary"
    ...
    def start_requests(self):
        try:
            ...
            # churl = 'https://thekhorasandiary.com/category/monitoring'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://thekhorasandiary.com/category/analysis',
            'https://thekhorasandiary.com/category/article',
            'https://thekhorasandiary.com/category/monitoring',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='recent-list-item']/div[@class='contents']/a/@href").getall()
        for link in links:
        ...
        next_urls = response.xpath("//ul[@class='pagination']/li[@class='page-item']/a[@rel='next']/@href").getall()

...
class TibetnetworkorgSpider(scrapy.Spider):
    name = "tibetnetworkorg"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://tibetnetwork.org/media-centre/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://tibetnetwork.org/media-centre/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='wpb_wrapper']//a[@title='Read more']/@href").getall()
        for link in links:
            if not link:
                continue

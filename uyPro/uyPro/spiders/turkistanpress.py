...
class TurkistanpressSpider(scrapy.Spider):
    name = "turkistanpress"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://turkistanpress.com/en/cat/islamic-world/1002'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            "https://turkistanpress.com/cat/dogu-turkistan/1000",
            "https://turkistanpress.com/cat/islam-dunyasi/1002",
            "https://turkistanpress.com/cat/dunya/1012",
            "https://turkistanpress.com/cat/makaleler/1001",
            "https://turkistanpress.com/cat/yayinlarimiz/1004",
            "https://turkistanpress.com/cat/flas-haber/1019",
            "https://turkistanpress.com/cat/karikatur/1020",
            "https://turkistanpress.com/ar/cat/1000",
            "https://turkistanpress.com/ar/cat/1002",
            "https://turkistanpress.com/ar/cat/1012",
            "https://turkistanpress.com/ar/posts",
            "https://turkistanpress.com/ar/cat/1013",
            "https://turkistanpress.com/ar/cat/1019",
            "https://turkistanpress.com/ar/cat/1020",
            "https://turkistanpress.com/en/cat/east-turkistan-news/1000",
            "https://turkistanpress.com/en/cat/islamic-world/1002",
            "https://turkistanpress.com/en/cat/world-news/1012",
            "https://turkistanpress.com/en/cat/our-publications/1004",
            "https://turkistanpress.com/en/cat/flash-news/1019",
            "https://turkistanpress.com/en/cat/caricature/1020",
        ]
        for link in chlinks:
        ...
        for div in divs:
            ...
            if self.redis_conn.hexists(f'{self.proname}_hash_done_urls', link_hash) and self.inc:
                ...
                if '.pdf' in link:
                    ...
                    item['tweet_url'] = link
                    item['tweet_id'] = link
                    lang = 'ar' if '/ar/' in response.url else 'en' if '/en/' in response.url else 'tr'

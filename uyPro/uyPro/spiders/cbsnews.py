...
class CbsnewsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            churl = 'https://www.cbsnews.com/tag/china/'
            inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            ...
            'https://www.cbsnews.com/tag/china/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[contains(@class,'col-8 ')]/section[contains(@id,'component-')]/div/article/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[contains(@class,'col-8 ')]/section[contains(@id,'component-')]/div/a[@data-component='inline-view-more']/@href").get()

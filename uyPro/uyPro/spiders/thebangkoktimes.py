...
class ThebangkoktimesSpider(scrapy.Spider):
    name = "thebangkoktimes"
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@id='content']/div[@class='row']/div/div[@class='post-item']/h3["
        ...
        next_url = response.xpath("//ul[@class='pagination']/li[@class='next']/a/@href").get()

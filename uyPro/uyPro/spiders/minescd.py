...
class MinescdSpider(scrapy.Spider):
    name = "minescd"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://mines.cd/category/appel-doffres/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://mines.cd/category/a-la-une/',
            'https://mines.cd/category/en-continu/',
            'https://mines.cd/category/grand-dossier/',
            'https://mines.cd/category/enquetes/',
            'https://mines.cd/category/energies-renouvelables/',
            'https://mines.cd/category/les-series/',
            'https://mines.cd/category/monde/',
            'https://mines.cd/category/podcast/',
            'https://mines.cd/category/appel-doffres/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//h3[@class='entry-title']/a/@href|//h2[@class='entry-title']/a/@href").getall()
        for link in links:
            if not link:
                continue

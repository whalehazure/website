...
class EnquetecdSpider(scrapy.Spider):
    name = "enquetecd"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://enquete.cd/categorie/justice/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://enquete.cd/categorie/politique/',
            'https://enquete.cd/categorie/economie/',
            'https://enquete.cd/categorie/societe/',
            'https://enquete.cd/categorie/securite/',
            'https://enquete.cd/categorie/environnement/',
            'https://enquete.cd/categorie/enquete/',
            'https://enquete.cd/categorie/justice/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//h3[@class='entry-title td-module-title']/a/@href").getall()
        for link in links:
            if not link:
                continue

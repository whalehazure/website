...
class VotorgSpider(scrapy.Spider):
    name = "votorg"
    ...
    def start_requests(self):
        # homepage = 'https://uyghur-j.org/japan/'
        # link = 'https://uyghur-j.org/japan/2023/11/interview-uyghur-camp-survivor-makes-' \
        #        'urgent-appeal-to-halt-genocide/'
        # churl = 'https://uyghur-j.org/japan/'
        homepage = ''
        try:
            ...
            # churl = 'https://cn.vot.org/category/%e6%b5%81%e4%ba%a1/'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://cn.vot.org/category/%e8%be%be%e8%b5%96%e5%96%87%e5%98%9b/',
            'https://cn.vot.org/category/%e8%a5%bf%e8%97%8f/',
            'https://cn.vot.org/category/%e6%b5%81%e4%ba%a1/',
            'https://cn.vot.org/category/%e5%9b%bd%e9%99%85/',
            'https://vot.org/category/%e0%bc%b8%e0%bd%82%e0%bd%bc%e0%bd%84%e0%bc%8b%e0%bd%a6%e0%bc%8b%e0%bd%98%e0%bd'
            '%86%e0%bd%bc%e0%bd%82/',
            'https://vot.org/category/%e0%bd%96%e0%bd%bc%e0%bd%91%e0%bc%8d/',
            'https://vot.org/category/%e0%bd%96%e0%bd%99%e0%bd%93%e0%bc%8b%e0%bd%96%e0%be%b1%e0%bd%bc%e0%bd%a3%e0%bc'
            '%8d/',
            'https://vot.org/category/%e0%bd%a2%e0%be%92%e0%be%b1%e0%bc%8b%e0%bd%93%e0%bd%82/',
            'https://vot.org/category/%e0%bd%a2%e0%be%92%e0%be%b1%e0%bd%a3%e0%bc%8b%e0%bd%a6%e0%be%a4%e0%be%b1%e0%bd'
            '%b2%e0%bc%8d/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@id='tdi_89']/div//h3/a/@href").getall()
        for link in links:
        ...
        next_url = response.xpath("//div[@class='page-nav td-pb-padding-side']/a[@aria-label='next-page']/@href").get()
    ...
    def article(self, response):
        ...
        lang = 'zh' if 'cn.vot.org' in response.meta['ch_url'] else 'bo'
        ...
        if tweet_func:
            translate = False if lang == 'zh' else True
            item = tweet_func(response, item, translate)
            if item:
                link_hash = hashlib.sha1(link.encode()).hexdigest()

...
class BbcSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.bbc.com/zhongwen/simp/topics/cxe2wdp384wt'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            ...
            'https://www.bbc.com/zhongwen/simp/topics/cxe2wdp384wt',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//main//ul[contains(@class,'bbc')]/li/div/div/h2/a/@href").getall()
        for link in links:
        ...
        next_url = response.xpath("//nav/span/a[@aria-labelledby='pagination-next-page']/@href").get()

...
class MvdtjSpider(scrapy.Spider):
    name = "mvdtj"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://mvd.tj/tj/habarho-boygoni/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://mvd.tj/tj/habarho-boygoni/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//main[@class='main clearfix']/div[@class='news-item clearfix']/a["
                               "@class='side-item-link']/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//span[@class='navigation']/span/following-sibling::a[1]/@href").get()

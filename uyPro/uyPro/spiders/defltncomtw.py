...
class DefltncomtwSpider(scrapy.Spider):
    name = "defltncomtw"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://def.ltn.com.tw/list/11'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//ul/li/a[@class='article-box']/@href").getall()
        for link in links:

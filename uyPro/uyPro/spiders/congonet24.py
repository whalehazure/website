...
class Congonet24Spider(scrapy.Spider):
    name = "congonet24"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://congonet24.com/category/politique/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://congonet24.com/category/economie-finance/',
            'https://congonet24.com/category/societe/',
            'https://congonet24.com/category/politique/'
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='newsx-grid-title']/h3/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@class='newsx-blog-pagination']/a[@class='newsx-next']/@href").get()

...
class ApnewsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://apnews.com/hub/asia-pacific'
            # inputdata = {}
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//bsp-custom-headline/h3[@class='PagePromo-title']/a/@href|//bsp-custom-headline/h2["
                               "@class='PagePromo-title']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@class='PageList-nextPage']/a[@class='Button']/@href").get()

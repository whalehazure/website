...
class CentcommilSpider(scrapy.Spider):
    name = "centcommil"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.centcom.mil/MEDIA/PRESS-RELEASES/'
            # inputdata = {}
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='alist newsrelease']/div[@class='item']/div[@class='info']/div["
                               "@class='title']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[@id]/div[@class='center-pager']/ul[@class='pagination']/li["
                                  "@class='active']/following-sibling::li[1]/a/@href").get('')

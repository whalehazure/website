...
class BitterwinterorgSpider(scrapy.Spider):
    name = "bitterwinterorg"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://bitterwinter.org/category/china/'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://bitterwinter.org/category/china/',
            'https://bitterwinter.org/category/from-world/',
            'https://bitterwinter.org/category/interviews/',
            'https://bitterwinter.org/category/documents/',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//main[@id='genesis-content']/article//h2[@class='entry-title']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//ul/li[@class='pagination-next']/a/@href").get()

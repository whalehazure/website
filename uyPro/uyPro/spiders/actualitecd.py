...
class ActualitecdSpider(scrapy.Spider):
    name = "actualitecd"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://actualite.cd/index.php/actualite'
            # inputdata = {}
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://actualite.cd/index.php/actualite',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//section[@id='content']//span[@class='field-content']/div[@id='actu-art']/div["
                               "@id='actu-titre']/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//li[@class='page-item pager__item--next']/a[@class='page-link']/@href").get()

...
class NewsmnSpider(scrapy.Spider):
    name = "newsmn"
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div/article//h1/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//ul/li/a[@class='next page-numbers']/@href").get()

...
class IcdforgtwSpider(scrapy.Spider):
    name = "icdforgtw"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.icdf.org.tw/wSite/lp?ctNode=31381&CtUnit=117&BaseDSD=7&mp=1#aC'
            # inputdata = {}
            self.taskid = taskid
    ...
    def parse(self, response, **kwargs):
        chlinks = [
            'https://www.icdf.org.tw/wSite/lp?ctNode=31381&CtUnit=117&BaseDSD=7&mp=1#aC',
        ]
        for link in chlinks:
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@class='newsmessage_list']/a/@href").getall()
        for link in links:
        ...
        next_url = response.xpath("//ul[@class='page']/li[@class='next']/a/@href").get('')

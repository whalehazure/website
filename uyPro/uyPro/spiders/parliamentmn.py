...
class ParliamentmnSpider(scrapy.Spider):
    name = "parliamentmn"
    ...
    def start_requests(self):
        ...
        try:
            ...
            # churl = 'https://www.parliament.mn/nn/'
            # inputdata = {}
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[contains(@class,'row')]/div[contains(@class,'entry')]//h3/a/@href").getall()
        for link in links:
            if not link:
                continue
        ...
        next_url = response.xpath("//div[contains(@class,'pagination')]/ul/li/a[text()='»']/@href").get()

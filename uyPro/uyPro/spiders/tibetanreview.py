...
class TibetanreviewSpider(scrapy.Spider):
    name = "tibetanreview"
    ...
    def start_requests(self):
        try:
            ...
            # churl = 'https://www.tibetanreview.net/category/opinions/'
            # inputdata = {}
            self.taskid = taskid
            ...
            if method == 'getchannel' and 'category/outside-tibet' in churl:
    ...
    def parse(self, response, **kwargs):
        ...
        chlinks = response.xpath("//ul[@id='menu-main-1']/li/ul[@class='sub-menu']/li/a/@href").getall()
        for link in chlinks:
    ...
    def parse_sec(self, response):
        if_new = False
        ch_url = response.meta['ch_url']
        links = response.xpath("//div[@id='tdi_105' or @id='tdi_100' or @id='tdi_105' or @id='tdi_106' or "
                               "@id='tdi_124' or @id='tdi_114' or @id='tdi_113']//div[@class='td-module-image' or "
                               "@class='td-image-container']/div["
                               "@class='td-module-thumb']/a/@href|//div[@class='item-details']/h3/a/@href|//div["
                               "@id='tdi_93']//div[@id='tdi_95']//div[@id='tdi_101']//div["
                               "@class='td-image-container']/div[@class='td-module-thumb']/a/@href").getall()
        for link in links:
        ...
        next_url = response.xpath(
            "//div[@class='page-nav td-pb-padding-side']/a[@aria-label='next-page']/@href").get()

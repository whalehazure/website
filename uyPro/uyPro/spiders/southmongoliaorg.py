...
class SouthmongoliaorgSpider(scrapy.Spider):
    name = "southmongoliaorg"
    ...
    def parse_sec(self, response):
        ...
        links = response.xpath("//div[@id='main-content']//article/h3/a/@href").getall()
        for link in links:
            if not link:
                continue
